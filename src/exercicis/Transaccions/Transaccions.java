 ...
 * la BD i els camps són autonumèrics. Utilitza Sentències preparades i Transaccions.
 *
 * @author sergi grau
...
public class Transaccions {
    ...
    private static boolean TRANSACCIO = false; // true si volem que cada op es confirmi
    public static void main(String args[])  {

        bd  = new BDAccessor();
        try {
            conn = bd.obtenirConnexio();
            conn.setAutoCommit(TRANSACCIO);
        ...
        do {
            ...
            switch (opcio) {
                ...
                case 4:
                     ...
                     entrada = new Scanner(System.in);
                    System.out.print("CONFIRMAR ELS CANVIS (s/n):");
    ...
    public static void afegirAlumne(String nom, float nota) throws SQLException {
        try {
            ...
            Savepoint svpt = conn.setSavepoint(); // en realitat hauriem d'emmagatzemar una llista de SavePoints
